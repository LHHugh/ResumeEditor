...
[![Version](https://img.shields.io/badge/version-v1.4.2-blue)](CHANGELOG)
...
| **模块管理** | 大模块自由增减（教育 / 工作 / 项目 / 技能 / 更多信息 / 作品 / 评价）；**长按拖动调整主区域 / 侧边栏模块顺序**；自定义模块支持四种内部结构 |
...
- **侧边栏模块**：在侧边栏模板下，可在「模块管理 → 侧边栏模块」单独增删，同样支持上述四种格式。
